 ...
 <body>
  <div class="navbar">
    ...
    <div class="navbar_right">
      <div class="navbar_right_up">

      </div>
      <div class="navbar_right_dwn">
  ...
  <div class="container">
    <div class="answer">
      ...
      <?php foreach ($questionone as $k=> $data) { ?>
        <h2><?php echo $k ?></h2>   <?php echo "<br>";  ?>

        <p><?php echo $data; ?></p>
     <?php }  ?>

     <?php foreach ($questiontwo as $k=> $data) { ?>
       <h2><?php echo $k ?></h2>   <?php echo "<br>";  ?>

       <p><?php echo $data; ?></p>
     <?php }  ?>

      <?php foreach ($questionthree as $k=> $data) { ?>
        <h2><?php echo $k ?></h2>   <?php echo "<br>";  ?>
     ...
     <?php }  ?>
       ...
       <?php foreach ($questionfour as $k=> $data) { ?>
         <h2><?php echo $k ?></h2>   <?php echo "<br>";  ?>
